...
\begin{figure}[htp]
    \begin{subfigure}[b]{1\textwidth}
        ...
        \begin{scope}
            \node[draw,circle] (v1) {};
            \node[draw,circle,below = of v1] (v2) {};
            \node[draw,circle,right = of v1] (v3) {};
            \node[draw,circle,below = of v3] (v4) {};
        \end{scope}
        
        %crosses
        \begin{scope}
            \path [-{Latex[length=3mm]}] (v1) edge[bend left] node[left] {} (v2);
            \path [-{Latex[length=3mm]}] (v2) edge[bend left] node[left] {} (v1);
            \path [-{Latex[length=3mm]}] (v1) edge[bend left] node[left] {} (v3);
            \path [-{Latex[length=3mm]}] (v3) edge[bend left] node[left] {} (v1);
            \path [-{Latex[length=3mm]}] (v1) edge node[left] {} (v4);
            \path [-{Latex[length=3mm]}] (v3) edge node[left] {} (v2);
            \path [-{Latex[length=3mm]}] (v2) edge node[left] {} (v4);
            \path [-{Latex[length=3mm]}] (v4) edge node[left] {} (v3);
        \end{scope}
        \end{tikzpicture}
    \end{subfigure}
...
\begin{figure}[htp]
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        %nodes
        \begin{scope}
            \node[draw,circle] (v1) {b};
            \node[draw,circle,below left = of v1] (v2) {a};
            \node[draw,circle,below right = of v1] (v3) {c};
        \end{scope}
        
        %crosses
        \begin{scope}
            \path [-{Latex[length=3mm]}] (v2) edge node[left] {} (v1);
            \path [-{Latex[length=3mm]}] (v1) edge node[left] {} (v3);
            \path [-{Latex[length=3mm]}] (v2) edge node[left] {} (v3);
        \end{scope}
        \end{tikzpicture}
        \caption{If $a \rightarrow b$ and $b \rightarrow c$ then $a \rightarrow c$ for all $a, b, c \in V$, then a digraph is a transitive digraph.}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \begin{scope}
            \path [-{Latex[length=3mm]}] (v2) edge node[left] {} (v1);
            \path [-{Latex[length=3mm]}] (v1) edge node[left] {} (v3);
            %\path [-{Latex[length=3mm]},dashed,gray] (v2) edge node[left] {} (v3);
            \path [<->,dashed] (v3) edge node[left] {} (v2);
        \end{scope}
        \end{tikzpicture}
        \caption{If $a \rightarrow b$ and $b \rightarrow c$ then $a$ and $c$ have to be adjacent for all $a, b, c \in V$, then a digraph is a quasi-transitive digraph.}
        \label{fig:quasitransitive}
    \end{subfigure}
\end{figure}
...
\begin{figure}[htp]
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \begin{scope}
            \node[draw,circle] (v1) {};
            \node[draw,circle,below left = 1cm and 0.5cm of v1] (v2) {};
            \node[draw,circle,below right = 1cm and 0.5cm of v1] (v3) {};
        \end{scope}
        
        %crosses
        \begin{scope}
            \path [-{Latex[length=3mm]}] (v2) edge node[left] {} (v1);
            \path [-{Latex[length=3mm]}] (v3) edge node[left] {} (v1);
            \path [<->,dashed] (v3) edge node[left] {} (v2);
        \end{scope}
        \end{tikzpicture}
        \caption{A locally in-semicomplete digraph has the invariant that if there are two incoming arcs, the source of those two arcs must have an arc between them.}
        \label{fig:localin}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        ...
        %crosses
        \begin{scope}
            \path [-{Latex[length=3mm]}] (v1) edge node[left] {} (v2);
            \path [-{Latex[length=3mm]}] (v1) edge node[left] {} (v3);
            \path [<->,dashed] (v3) edge node[left] {} (v2);
        \end{scope}
        \end{tikzpicture}
        \caption{A locally out-semicomplete digraph has the invariant that if there are two outgoing arcs, the sink of those two arcs must have an arc between them.}
        \label{fig:localout}
    \end{subfigure}
\end{figure}
